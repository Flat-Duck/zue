...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    <th class="text-left">@lang('crud.flights.inputs.type')</th>
                    <th class="text-left">@lang('crud.flights.inputs.date')</th>
                    <th class="text-left">@lang('crud.flights.inputs.time')</th>
                ...
                <tr>
                    ...
                    <td class="text-center" style="width: 134px;">
                        ...
                        >
                            @can('update', $flight)
                            <a
                                href="{{ route('flights.edit', $flight) }}"
