...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    <th class="text-left">@lang('crud.centers.inputs.name')</th>
                ...
                <tr>
                    ...
                    <td class="text-center" style="width: 134px;">
                        ...
                        >
                            ...
                            @endcan @can('view', $center)
                            <a
                                href="{{ route('centers.show', $center) }}"
                                class="btn btn-icon btn-outline-info ms-1"
                            >
                                <i class="ti ti-eye"></i>
                            </a>
                            @endcan @can('delete', $center)
                            <form
                                action="{{ route('centers.destroy', $center) }}"
                                method="POST"
