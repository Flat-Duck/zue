<div>
    <div class="mb-4">
        ...
        <button class="btn btn-primary" wire:click="newPassenger">
    ...
    <div class="table-responsive">
        <table class="table" id="dataTable" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>#</th>
                    <th>@lang('crud.flight_passengers.inputs.passenger_id')</th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                @foreach ($flightPassengers as $k=> $passenger)
                <tr>
                    <td>{{ $k+1 }}</td>
    ...
    @if( $flightPassengers->hasPages() )
    <div class="card-footer pb-0">{{ $flightPassengers->links() }}</div>
    @endif
</div>
